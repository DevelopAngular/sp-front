...
describe('Admin - UI and Actions', () => {
  ...
  describe('Rooms', () => {
    ...
    describe.skip('Create and delete a room', function () {
      let roomsNum: number;
  ...
  <<<<<<< HEAD
        ...
        describe('pass student view reflect room modifications', function () {
          ...
          it('should modify test room', function () {
            cy.get('app-pinnable-collection app-pinnable div.title').contains(` ${ROOM_TITLE} `).wait(1000).click({
              timeout: 10000,
              force: true
            });
      ...
      describe('Enable/Disable a room', () => {
        ...
        it('should disable a room', () => {
          cy.intercept({
            method: 'PATCH',
            url: 'https://smartpass.app/api/prod-us-central/v1/locations/**'
          }).as('updateLocation');
          ...
          cy
            .get('app-pinnable-collection app-pinnable div.title').contains(` Bathroom `)
            .parent().parent().parent().find('div:first-child')
            .should('not.have.class', 'disabled');

          cy.get('app-pinnable-collection app-pinnable div.title').contains(` Bathroom `).wait(1000).click({
            timeout: 10000,
            force: true
          });

          waitForElement('app-overlay-container')
            .get('div.enable-room div.toggle-button')
            .click();

          cy.get('app-consent-menu div.option-wrapper').click();
          waitForElement('app-overlay-container div.right-button app-gradient-button > div').click();
          cy.wait('@updateLocation');
          cy.wait('@updatePinnable');
          cy
            .get('app-pinnable-collection app-pinnable div.title').contains(` Bathroom `)
            .parent().parent().parent().find('div:first-child')
          ...
          // cy
          //   .get('app-pinnable div.title').contains(` Bathroom `)
          //   .parent().parent().parent().find('div:first-child')
          //   .should('have.class', 'disabled');
