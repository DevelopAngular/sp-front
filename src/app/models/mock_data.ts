...
export const testStudent = new User('testStudent', true, new Date(), false, new Date(),  new Date(), 'Kyle', 'Cook', 'Kyle Cook', false, 'mail@mail.com', [], 'active', null, [], true, null, '', {}, null, '10', '', null);
export const testIssuer = new User('141', true, new Date(), false, new Date(),  new Date(), 'Donald', 'Sawyer', 'Don Sawyer', false, 'mail@mail.com', [], 'active', null, [], true, null, '', {}, null, '12', '', null);
export const testOrigin = new Location('testOrigin', 'Ladson', 'MHS', 'C123', 'classroom', false, '', true, true, [], false, '', true, true, [], [], [], [], 15, false, 0, false, 0, false, false, true, 'visible_all_students', [], null);
export const testDestination = new Location('testDestination', 'Water Fountain', 'MHS', 'WF', '', false, '', true, true, [], false, '', true, true, [], [],
  ['round_trip', 'one_way'], [], 15, false, 0, false, 0, false, false, true, 'visible_all_students', [], null);
