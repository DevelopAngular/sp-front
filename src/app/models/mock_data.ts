...
export const testOrigin = new Location('testOrigin', 'Ladson', 'MHS', 'C123', 'classroom', false, '', true, true, [], false, '', true, true, [], [], [], [], 15, false, 0, false, 0, false,false, true, 'visible_all_students', []);
export const testDestination = new Location('testDestination', 'Water Fountain', 'MHS', 'WF', '', false, '', true, true, [], false, '', true, true, [], [],
  ['round_trip', 'one_way'], [], 15, false, 0, false, 0, false,false, true, 'visible_all_students', [] );
