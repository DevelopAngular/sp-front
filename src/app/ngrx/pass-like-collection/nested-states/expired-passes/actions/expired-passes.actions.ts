...
export const getMoreExpiredPasses = createAction(`[${EXPIREDPASSES}] Get More Expired Passes`, props<{timeFilter: string}>());
...
export const filterExpiredPasses = createAction(`[${EXPIREDPASSES}] Filter Passes`, props<{timeFilter: string}>());
