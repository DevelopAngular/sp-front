...
export const getParentsAccountsProfiles = createSelector(
  getAccountsState,
  (state: IAccountsState) => state.parentsAccounts
);

export const getLoadedParents = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.loaded
);

export const getLoadingParents = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.loading
);

export const getNextRequestParents = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.nextRequest
);

export const getLastAddedParents = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => {
...
export const getParentSort = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.sortValue
);

export const getAddedParent = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.addedUser
);

export const getCurrentUpdatedParent = createSelector(
  getParentsAccountsProfiles,
  (state: ParentsStates) => state.currentUpdatedAccount
);
