...
export const getEncounterDetectionSuccess = createAction(`[${ENCOUNTERDETECTION}] Get Encounter Detection Success`, props<{encounterDetection: EncounterDetection[], createdAt: Date}>());
