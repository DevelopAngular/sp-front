...
export class NavComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  views: View = {
    ...
    'encounter_detection': {id: 4, title: 'Encounter Detection', color: '#1F195E', icon: 'Encounter Detection', action: 'encounter_detection', isPro: !this.userService.getFeatureEncounterDetection()},
