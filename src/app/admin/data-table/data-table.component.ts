    ...
    if (!this.dataSource) {
      ...
      this.dataSource.offsetChange
        ...
        .subscribe(offset => {
          ...
          // console.log(((this.dataSource.last * 50) - (Math.ceil(offset / PAGESIZE) + (isFirst ? 10 : 0 ) - (isThree ? this.dataSource.last * 10 : 0))) + (isFour ? 60 : 0), (this.dataSource.last * 50) - 20, this.dataSource.last);

          console.log(((this.dataSource.last * ( isFirst ? 40 : 60)) + (isThree ? (this.counter * 30) : 0)) - Math.ceil(offset / PAGESIZE), Math.ceil(offset / PAGESIZE), (this.dataSource.last * 50) - 20, this.dataSource.last);
          ...
          if (((this.dataSource.last * ( isFirst ? 40 : 60)) + (isThree ? (this.counter * 20) : 0)) - Math.ceil(offset / PAGESIZE) === (this.dataSource.last * 50) - 20) {
            if (isThree) {
              this.counter += 1;
            }
